...
<body>
   <div class="title-container">
      <h1>Calculadora Cyberpunk foda </h1>
   </div>
   <div class="calculator-container">
      <form action="" method="post" id="calculator-form">
         ...
         <input type="submit" name="operacao" value="/">  
         <br>
         <button type="button" id="save-operation" class="neon-text">Salvar Operação</button>
         <button type="button" id="show-operation" class="neon-text">Mostrar Operação Salva</button>
      </form> 
      <div id="result"></div>
   </div>
